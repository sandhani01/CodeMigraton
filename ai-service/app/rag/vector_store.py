"""In-Memory Vector Store with Semantic Version Filtering.

Stores EvidenceChunk objects along with dense embeddings.
Performs transparent cosine similarity search with strict version interval constraints.
"""
...
class InMemoryVectorStore:
    ...
    def add_documents(self, chunks: List[EvidenceChunk]) -> None:
        """Adds and indexes evidence chunks."""
    ...
    def search_vector(
        ...
        """Vector similarity search filtered by version interval."""
    ...
    def search_exact(
        ...
        """Exact or substring symbol matching for high-precision API retrieval."""
